...
def main():
    # Ask for model name
    model_name = input("Enter the name of the model for this evaluation (default: ANN Model): ") or "ANN Model"
    model_name = re.sub(r'[^\w\s-]', '', model_name)  # Sanitize input
    
    # Set paths for ANN output
    csv_path = input("Enter the path to the CSV results file (default: test_predictions/ann/results/ann_predictions.csv): ") or "test_predictions/ann/results/ann_predictions.csv"
    output_dir = input("Enter the directory for output reports (default: test_predictions/ann/results/report): ") or "test_predictions/ann/results/report"
    ...
    if not os.path.exists(csv_path):
        ...
        for possible_path in [
            "test_predictions/ann/results/ann_predictions.csv",
            "test_predictions/ann/results/full_analysis_results.csv"
        ]:
